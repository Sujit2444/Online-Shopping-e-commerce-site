	...
	<div class="adminMenu">
		...
		<ul>	
           ...
           <li><a href="editCategory.php">Edit Categories</a></li>			 
			...
			<li><a href="editProduct0.php">Edit Product</a></li>
	  ...
	  <li><a href="des.php">Product Description</a></li>
		 <li><a href="sup.php">ADD SUPPLIER</a></li>
		 <li><a href="sup1.php">Edit SUPPLIER</a></li>		
		<li><a href="sup4.php">Delete SUPPLIER</a></li>		
		</ul>
